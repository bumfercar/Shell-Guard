...
이 PR에서 민감 정보가 발견되어 추가 분석이 중단되었습니다.
...
**⚠️ 즉시 조치 필요:**
1. 모든 민감 정보를 코드에서 제거하세요
2. 발견된 키/토큰이 유출된 경우 즉시 폐기하고 새로 발급하세요
3. 환경 변수 또는 시크릿 관리 시스템을 사용하세요
4. 절대 커밋 히스토리에 민감 정보를 남기지 마세요
